...
The [runbook](3.Runbook.md) supplies the proposed instructions and single-skill draft.
The old snapshot-specific skill files and reconstruction JSON remain historical resources,
not mandatory components for this path. Compatibility of each original flow's tool contract
still needs confirming in the target environment.
